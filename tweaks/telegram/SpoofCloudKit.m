...
void install_cloudkit_bypass() {
    ...
    replaceClassSelector(
        ...
        (IMP)^(id self, SEL _cmd, CKAccountStatusBlock completionHandler) {
    ...
    method_setImplementation(m, (IMP)^(id self, SEL _cmd, NSString *identifier) {
